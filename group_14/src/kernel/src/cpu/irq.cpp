// Soruce: https://github.com/perara-lectures/ikt218-osdev/blob/master/group_per-arne/src/kernel/src/cpu/irq.cpp Fetched 17.04.23
...
void irq_handler(registers_t regs)
{
    ...
    int_handler_t intrpt = irq_handlers[regs.int_nr];
    if (intrpt.handler != 0)
    {
