...
extern void init_gdt() asm ("init_gdt"); // asm "init_gdt is needed, do NOT remove"
extern "C" {
  extern void gdt_flush(uint32_t);
  void gdt_set_gate(int32_t,uint32_t,uint32_t,uint8_t,uint8_t); // Make it static? maybe both func?
}
