...
.end:
 ...
 ;USED Lectureres Repository for the bootprocess and code: https://github.com/uiaict/ikt218-osdev/pull/1
 ;AND THIS GUIDE: https://wiki.osdev.org/Bare_Bones#Implementing_the_Kernel
